...
function preload()
{
  sourceImg = loadImage("naranja2.webp");
  // sourceImg = loadImage("noun-orange.png");
  print("sourceImg loaded");
...
// Make sure p5 sees your handlers even if something changes script context
